    ...
    return (
        <section>
            <div className='main-spa h-svh' style={{backgroundImage: `url(${backgroundMain})`}}>
                <h1 className='text-4xl font-black md:text-5xl lg:text-6xl p-4 spa-titles main-title-spa' id='introduccion'>Egresados San Isidoro {new Date().getFullYear()}</h1>
                ...
                <div className='text-sm desc-spa4 font-extrabold bg-gray-800 w-96 p-5 opacity-90 transition-all icon-title-cont rounded-lg'>
